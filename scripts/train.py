...
def main():
    ...
    # Generate audio from supplied spectrogram
    if inference:
        # sample_voc = []
        # sample_audio = []
        ...
        with torch.no_grad():
            ...
            # for i, (voc, _) in enumerate(zip(sample_voc, sample_audio)):
            #     pred_audio = netG(voc)
            #     pred_audio = pred_audio.squeeze().cpu()
